-- PostGIS function for hybrid water body click detection
-- Supports both SMHI unified lakes and OSM detailed water bodies

DROP FUNCTION IF EXISTS find_hybrid_water_body_containing_point(NUMERIC, NUMERIC, NUMERIC);

CREATE OR REPLACE FUNCTION find_hybrid_water_body_containing_point(
  click_lat NUMERIC,
  click_lon NUMERIC,
