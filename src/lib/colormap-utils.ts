...
const COLORMAP_DATA = {
  current: [
    ...
    { value: 0.479, color: '#FFFF00' },
    { value: 0.547, color: '#FFFF00' },
    { value: 0.616, color: '#FFFF00' },
    { value: 0.684, color: '#FFFF00' },
    { value: 0.753, color: '#FFCC00' },
    { value: 0.821, color: '#FF9900' },
    { value: 0.889, color: '#FF6600' },
    { value: 0.958, color: '#FF3300' },
    { value: 1.026, color: '#FF0066' },
    { value: 1.095, color: '#FF00FF' },
    { value: 1.163, color: '#CC00FF' },
    { value: 1.232, color: '#9900FF' },
    { value: 1.300, color: '#000000' }
  ],
  temperature: [
