...
// Skalfaktor för pilarnas längd (1 = original, 2 = dubbelt så långa, osv)
...
export default function CurrentVectorsLayer() {
  ...
  // 4) Rendera pilar med glow + pilhuvud
  useEffect(() => {
    ...
    for (const pt of gridData) {
      // Täthetsfilter
      if (used.some(u => haversineDistance(u.lat,u.lng,pt.lat,pt.lon) < minD)) {
        continue;
      }
      ...
      // Beräkna pilens slutpunkt med LENGTH_FACTOR
      const baseLen = 0.05;
      const len = baseLen * LENGTH_FACTOR;
