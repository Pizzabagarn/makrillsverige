...
-- Dessa index är designade för de absolut vanligaste queries
...
-- VACUUM för att optimera storage
VACUUM ANALYZE water_bodies_fast_lookup;
...
-- PERFORMANCE HINT: Sätt work_mem högt för dessa queries
-- SET work_mem = '256MB'; -- Kör bara vid behov, inte permanent