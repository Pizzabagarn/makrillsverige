-- KRITISK CLICK-FUNKTION för water_bodies_with_places_fast_lookup
-- EXAKT samma logik som det gamla systemet!

CREATE OR REPLACE FUNCTION find_water_body_with_places_fast_containing_point(
  click_lat NUMERIC,
  click_lon NUMERIC,
